...
export function SaveCodeDialog({ forceCreate = false }: Props) {
    ...
    const { slides, updateSlide, id: animationId, name: existingName, description: existingDescription } = useUIStore();
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>{isCreating ? 'Create New Animation' : 'Update Animation'}</DialogTitle>
                </DialogHeader>
