...
export const PricingCard = ({
    ...
    <div className={cn("relative mt-12 flex h-full flex-col pb-2 text-start max-w-sm")}>
        {isPopular && (
            <motion.div
        ...
        >
            ...
            <div className="mt-auto">
                <motion.div variants={PRICING_ANIMATION_VARIANTS.button} initial="hidden" animate="visible">
                    <Button
                        type="button"
